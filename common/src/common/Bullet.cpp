...
Bullet::Bullet(Character* user,
        ...
        HoveringObject(position,
                       ...
                       {j3x::get<float>(RM.getObjectParams("bullets", id), "size_x"),
                        j3x::get<float>(RM.getObjectParams("bullets", id), "size_y")},
                       collision::Box(j3x::get<float>(RM.getObjectParams("bullets", id), "size_x"),
                                      j3x::get<float>(RM.getObjectParams("bullets", id), "size_y"),
                                      {j3x::get<float>(RM.getObjectParams("bullets", id), "collision_offset_x"),
                                       j3x::get<float>(RM.getObjectParams("bullets", id),
                                               "collision_offset_y")}),
