...
void J3XVisitor::visitDef(Def* t)
{
} //abstract class
void J3XVisitor::visitType(Type* t)
{
} //abstract class
void J3XVisitor::visitExpr(Expr* t)
{
} //abstract class
...
void J3XVisitor::visitVarDef(VarDef* vardef)
{
    ...
    else
    {
        throw std::invalid_argument(
                "line number " + std::to_string(vardef->line_number_) + " - Variable " + vardef->ident_ +
                " assign failed. Assigned type \"" +
...
void J3XVisitor::visitEAdd(EAdd* eadd)
{
    ...
    {
        eadd->value_ = std::any_cast<float>(eadd->expr_1->value_) +
                       static_cast<float>(std::any_cast<int>(eadd->expr_2->value_));
        eadd->strtype_ = "float";
    }
    else if (eadd->expr_1->strtype_ == "int" and eadd->expr_2->strtype_ == "float")
    {
        eadd->value_ = static_cast<float>(std::any_cast<int>(eadd->expr_1->value_)) +
                       std::any_cast<float>(eadd->expr_2->value_);
        eadd->strtype_ = "float";
    }
    ...
    {
        eadd->value_ =
                std::any_cast<sf::Vector2f>(eadd->expr_1->value_) + std::any_cast<sf::Vector2f>(eadd->expr_2->value_);
        eadd->strtype_ = "vector";
    }
    else
    {
        throw std::invalid_argument("line number " + std::to_string(eadd->line_number_) +
                                    " - Addition can be performed only on numbers and vectors!");
    }
}
...
void J3XVisitor::visitESub(ESub* esub)
{
    ...
    {
        esub->value_ = std::any_cast<float>(esub->expr_1->value_) -
                       static_cast<float>(std::any_cast<int>(esub->expr_2->value_));
        esub->strtype_ = "float";
    }
    else if (esub->expr_1->strtype_ == "int" and esub->expr_2->strtype_ == "float")
    {
        esub->value_ = static_cast<float>(std::any_cast<int>(esub->expr_1->value_)) -
                       std::any_cast<float>(esub->expr_2->value_);
        esub->strtype_ = "float";
    }
    ...
    {
        esub->value_ =
                std::any_cast<sf::Vector2f>(esub->expr_1->value_) - std::any_cast<sf::Vector2f>(esub->expr_2->value_);
        esub->strtype_ = "vector";
    }
    else
    {
        throw std::invalid_argument("line number " + std::to_string(esub->line_number_) +
                                    " - Subtraction can be performed only on numbers and vectors!");
    }
}
...
void J3XVisitor::visitEMul(EMul* emul)
{
    ...
    {
        emul->value_ = std::any_cast<float>(emul->expr_1->value_) *
                       static_cast<float>(std::any_cast<int>(emul->expr_2->value_));
        emul->strtype_ = "float";
    }
    else if (emul->expr_1->strtype_ == "int" and emul->expr_2->strtype_ == "float")
    {
        emul->value_ = static_cast<float>(std::any_cast<int>(emul->expr_1->value_)) *
                       std::any_cast<float>(emul->expr_2->value_);
        emul->strtype_ = "float";
    }
    ...
    {
        throw std::invalid_argument("line number " + std::to_string(emul->line_number_) +
                                    " - Multiplication can be performed only on numbers or with scalar and vector!");
    }
}
...
void J3XVisitor::visitEDiv(EDiv* ediv)
{
    ...
    {
        ediv->value_ = std::any_cast<float>(ediv->expr_1->value_) /
                       static_cast<float>(std::any_cast<int>(ediv->expr_2->value_));
        ediv->strtype_ = "float";
    }
    else if (ediv->expr_1->strtype_ == "int" and ediv->expr_2->strtype_ == "float")
    {
        ediv->value_ = static_cast<float>(std::any_cast<int>(ediv->expr_1->value_)) /
                       std::any_cast<float>(ediv->expr_2->value_);
        ediv->strtype_ = "float";
    }
    ...
    {
        throw std::invalid_argument("line number " + std::to_string(ediv->line_number_) +
                                    " - Division can be performed only on numbers or with vector and scalar!");
    }
}
...
void J3XVisitor::visitENeg(ENeg* eneg)
{
    ...
    {
        throw std::invalid_argument("line number " + std::to_string(eneg->line_number_) +
                                    " - Negation can be performed only on numbers or vectors!");
    }
}
...
void J3XVisitor::visitEVector(EVector* evector)
{
    ...
    {
        throw std::invalid_argument("line number " + std::to_string(evector->line_number_) +
                                    " - Vector can be constructed only from numbers!");
    }
}
