        ...
        time_elapsed_(CONF<float>("graphics/achievement_show_time"))
{
    ...
    bg_[1].position = sf::Vector2f(position.x - CONF<sf::Vector2f>("graphics/achievement_size").x, - CONF<sf::Vector2f>("graphics/achievement_size").y);
    bg_[2].position = sf::Vector2f(position.x - CONF<sf::Vector2f>("graphics/achievement_size").x, - CONF<sf::Vector2f>("graphics/achievement_size").y);
...
bool Achievement::update(float time_elapsed)
{
    ...
    title_text_.setPosition(curr_pos + CONF<sf::Vector2f>("graphics/achievement_title_pos") - sf::Vector2f{title_bounds_.width / 2.0f, 0});
