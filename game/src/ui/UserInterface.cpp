...
UserInterface::UserInterface() :
        ...
        object_use_text_("[F] Use object", RM.getFont("editor"), 12 * CFG.get<float>("graphics/user_interface_zoom")),
        npc_talk_text_("[T] Talk to NPC", RM.getFont("editor"), 12 * CFG.get<float>("graphics/user_interface_zoom")),
