...
public:
    ...
    void spawnSparksAnimation(const sf::Vector2f &pos, const float dir, const float r);
    void spawnShotAnimation(const sf::Vector2f &pos, const float dir, const float r);
