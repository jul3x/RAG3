...
Player::Player(const sf::Vector2f &position,
    ...
    weapons_in_backpack_.push_back(
        std::make_unique<Weapon>(ResourceManager::getInstance().getWeapon("m4")));
    weapons_in_backpack_.push_back(
        std::make_unique<Weapon>(ResourceManager::getInstance().getWeapon("desert_eagle")));
    weapons_in_backpack_.push_back(
        std::make_unique<Weapon>(ResourceManager::getInstance().getWeapon("shotgun")));
    weapons_in_backpack_.push_back(
        std::make_unique<Weapon>(ResourceManager::getInstance().getWeapon("rocket_launcher")));
    weapons_in_backpack_.push_back(
